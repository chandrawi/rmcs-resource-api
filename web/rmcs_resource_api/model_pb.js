...
goog.exportSymbol('proto.model.ModelTypes', null, global);
 ...
 * @constructor
 */
proto.model.ModelTypes = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.model.ModelTypes.repeatedFields_, null);
};
goog.inherits(proto.model.ModelTypes, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.model.ModelTypes.displayName = 'proto.model.ModelTypes';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
...
/**
 * repeated common.DataType types = 5;
 * @return {!Array<!proto.common.DataType>}
 */
proto.model.ModelSchema.prototype.getTypesList = function() {
 ...
 * @return {!proto.model.ModelSchema} returns this
 */
proto.model.ModelSchema.prototype.setTypesList = function(value) {
 ...
 * @return {!proto.model.ModelSchema} returns this
 */
proto.model.ModelSchema.prototype.addTypes = function(value, opt_index) {
 ...
 * @return {!proto.model.ModelSchema} returns this
 */
proto.model.ModelSchema.prototype.clearTypesList = function() {
 ...
 * @const
 */
proto.model.ModelTypes.repeatedFields_ = [6];
 ...
 * @return {!Object}
 */
proto.model.ModelTypes.prototype.toObject = function(opt_includeInstance) {
  return proto.model.ModelTypes.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.model.ModelTypes} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.model.ModelTypes.toObject = function(includeInstance, msg) {
  var f, obj = {
    id: msg.getId_asB64(),
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.model.ModelTypes}
 */
proto.model.ModelTypes.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.model.ModelTypes;
  return proto.model.ModelTypes.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.model.ModelTypes} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.model.ModelTypes}
 */
proto.model.ModelTypes.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.model.ModelTypes.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.model.ModelTypes.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.model.ModelTypes} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.model.ModelTypes.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getId_asU8();
  if (f.length > 0) {
    writer.writeBytes(
 ...
 * @return {string}
 */
proto.model.ModelTypes.prototype.getId = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
 ...
 * @return {string}
 */
proto.model.ModelTypes.prototype.getId_asB64 = function() {
  return /** @type {string} */ (jspb.Message.bytesAsB64(
      this.getId()));
};
 ...
 * @return {!Uint8Array}
 */
proto.model.ModelTypes.prototype.getId_asU8 = function() {
  return /** @type {!Uint8Array} */ (jspb.Message.bytesAsU8(
      this.getId()));
};
...
/**
 * @param {!(string|Uint8Array)} value
 * @return {!proto.model.ModelTypes} returns this
 */
proto.model.ModelTypes.prototype.setId = function(value) {
  return jspb.Message.setProto3BytesField(this, 1, value);
};
 ...
 * @return {!Array<!proto.common.DataType>}
 */
proto.model.ModelTypes.prototype.getTypesList = function() {
 ...
 * @return {!proto.model.ModelTypes} returns this
 */
proto.model.ModelTypes.prototype.setTypesList = function(value) {
 ...
 * @return {!proto.model.ModelTypes} returns this
 */
proto.model.ModelTypes.prototype.addTypes = function(value, opt_index) {
 ...
 * @return {!proto.model.ModelTypes} returns this
 */
proto.model.ModelTypes.prototype.clearTypesList = function() {
  return this.setTypesList([]);
};
