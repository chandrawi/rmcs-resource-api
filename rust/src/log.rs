...
pub struct LogUpdate {
    ...
    pub log_type: ::core::option::Option<u32>,
    #[prost(int32, optional, tag = "4")]
    pub tag: ::core::option::Option<i32>,
}
#[derive(Clone, PartialEq, Eq, Hash, ::prost::Message)]
pub struct LogUpdateTime {
    #[prost(int64, tag = "1")]
    pub timestamp: i64,
    #[prost(bytes = "vec", optional, tag = "2")]
    pub device_id: ::core::option::Option<::prost::alloc::vec::Vec<u8>>,
...
pub mod log_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn create_log(
            ...
            tonic::Response<super::LogCreateResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
        ...
        pub async fn update_log_by_time(
            &mut self,
            request: impl tonic::IntoRequest<super::LogUpdateTime>,
        ) -> std::result::Result<
            tonic::Response<super::LogChangeResponse>,
            tonic::Status,
        > {
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("log.LogService", "UpdateLogByTime"));
            self.inner.unary(req, path, codec).await
        }
        ...
        pub async fn delete_log_by_time(
            &mut self,
            request: impl tonic::IntoRequest<super::LogTime>,
        ) -> std::result::Result<
            tonic::Response<super::LogChangeResponse>,
        ...
        > {
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("log.LogService", "DeleteLogByTime"));
            self.inner.unary(req, path, codec).await
        }
    }
}
...
pub mod log_service_server {
    ...
    pub trait LogService: std::marker::Send + std::marker::Sync + 'static {
        ...
        async fn update_log(
            ...
            tonic::Status,
        >;
        async fn update_log_by_time(
            &self,
            request: tonic::Request<super::LogUpdateTime>,
        ) -> std::result::Result<
            tonic::Response<super::LogChangeResponse>,
            tonic::Status,
        >;
        ...
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/log.LogService/ReadLog" => {
                    ...
                    for ReadLogSvc<T> {
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as LogService>::read_log(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/log.LogService/ReadLogByTime" => {
                    #[allow(non_camel_case_types)]
                    struct ReadLogByTimeSvc<T: LogService>(pub Arc<T>);
                    impl<T: LogService> tonic::server::UnaryService<super::LogTime>
                    for ReadLogByTimeSvc<T> {
                        type Response = super::LogReadResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as LogService>::read_log_by_time(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = ReadLogByTimeSvc(inner);
                        let codec = tonic_prost::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/log.LogService/ListLogByTime" => {
                    ...
                    for ListLogByTimeSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as LogService>::list_log_by_time(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/log.LogService/CreateLog" => {
                    ...
                    for CreateLogSvc<T> {
                        type Response = super::LogCreateResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as LogService>::create_log(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/log.LogService/UpdateLog" => {
                    ...
                    for UpdateLogSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as LogService>::update_log(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/log.LogService/UpdateLogByTime" => {
                    #[allow(non_camel_case_types)]
                    struct UpdateLogByTimeSvc<T: LogService>(pub Arc<T>);
                    impl<T: LogService> tonic::server::UnaryService<super::LogUpdateTime>
                    for UpdateLogByTimeSvc<T> {
                        type Response = super::LogChangeResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as LogService>::update_log_by_time(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = UpdateLogByTimeSvc(inner);
                        let codec = tonic_prost::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/log.LogService/DeleteLog" => {
                    ...
                    for DeleteLogSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as LogService>::delete_log(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/log.LogService/DeleteLogByTime" => {
                    #[allow(non_camel_case_types)]
                    struct DeleteLogByTimeSvc<T: LogService>(pub Arc<T>);
                    impl<T: LogService> tonic::server::UnaryService<super::LogTime>
                    for DeleteLogByTimeSvc<T> {
                        type Response = super::LogChangeResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as LogService>::delete_log_by_time(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = DeleteLogByTimeSvc(inner);
                        let codec = tonic_prost::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
    ...
    pub const SERVICE_NAME: &str = "log.LogService";
